  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        ...
        <StatCard label="Diferença a acompanhar" value={FECHAMENTO_AGOSTO.saldo.total - FECHAMENTO_AGOSTO.saldoOnline.total} accent={(FECHAMENTO_AGOSTO.saldo.total - FECHAMENTO_AGOSTO.saldoOnline.total) >= 0 ? GREEN : RED} />
